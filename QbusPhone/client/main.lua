...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(10)
        if GOVCore == nil then
            TriggerEvent('GOVCore:GetObject', function(obj) GOVCore = obj end)
            Citizen.Wait(200)
        end
    end
end)
...
RegisterNetEvent('GOVCore:Client:OnJobUpdate')
AddEventHandler('GOVCore:Client:OnJobUpdate', function(JobInfo)
        ...
        if IsControlJustPressed(0, Config.OpenPhone) then
            if not PhoneData.isOpen then
                ...
                if not IsHandcuffed then
                    ...
                    GOVCore.Functions.Notify("Action currently not possible..", "error")
                end
            end
        end
        Citizen.Wait(3)
...
function test()
    ...
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetPhoneData', function(pData)
...
function LoadPhone()
    ...
    isLoggedIn = true
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetPhoneData', function(pData)
        PlayerJob = GOVCore.Functions.GetPlayerData().job
        PhoneData.PlayerData = GOVCore.Functions.GetPlayerData()
...
RegisterNetEvent('GOVCore:Client:OnPlayerLoaded')
AddEventHandler('GOVCore:Client:OnPlayerLoaded', function()
    LoadPhone()
end)

RegisterNUICallback('HasPhone', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:HasPhone', function(HasPhone)
        cb(HasPhone)
    end)
end)
...
function OpenPhone()
    GOVCore.Functions.TriggerCallback('gov-phone:server:HasPhone', function(HasPhone)
        if HasPhone then
            ...
            GOVCore.Functions.TriggerCallback('gov-phone:server:GetGarageVehicles', function(vehicles)
                PhoneData.GarageVehicles = vehicles
            end)
        else
            GOVCore.Functions.Notify("You don't have a phone", "error")
        end
    end)
end
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
AddEventHandler('gov-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
    ...
    if New then
        ...
        if PhoneData.isOpen then
            ...
            Wait(100)
            GOVCore.Functions.TriggerCallback('gov-phone:server:GetContactPictures', function(Chats)
                SendNUIMessage({
                    action = "UpdateChat",
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    GOVCore.Functions.TriggerCallback('gov-phone:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    GOVCore.Functions.TriggerCallback('gov-phone:server:DeclineInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('CallContact', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetCallState', function(CanCall, IsOnline)
        local status = { 
            CanCall = CanCall, 
            IsOnline = IsOnline,
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:FetchResult', function(result)
        print('test')
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('FetchVehicleResults', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetVehicleSearchResults', function(result)
        if result ~= nil then 
            for k, v in pairs(result) do
                GOVCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    local vehicle = GOVCore.Functions.GetClosestVehicle()
    local plate = GetVehicleNumberPlateText(vehicle)
    local model = GetEntityModel(vehicle)

    GOVCore.Functions.TriggerCallback('gov-phone:server:ScanPlate', function(result)
        GOVCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNUICallback('SetAlertWaypoint', function(data)
    ...
    GOVCore.Functions.Notify('GPS Locatie ingesteld: '..data.alert.title)
...
function GetClosestPlayer()
    local closestPlayers = GOVCore.Functions.GetPlayersFromCoords()
...
AddEventHandler('gov-phone:client:GiveContactDetails', function()
    ...
    if player ~= -1 and distance < 2.5 then
        ...
        GOVCore.Functions.Notify("No one around!", "error")
    end
end)
...
RegisterNUICallback('GetCryptoData', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-crypto:server:GetCryptoData', function(CryptoData)
        cb(CryptoData)
    end, data.crypto)
end)

RegisterNUICallback('BuyCrypto', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-crypto:server:BuyCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('SellCrypto', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-crypto:server:SellCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('TransferCrypto', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-crypto:server:TransferCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)
...
RegisterNUICallback('GetAvailableRaces', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end)
end)
...
RegisterNUICallback('GetRaces', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('HasCreatedRace', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)
...
RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
...
RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:GetRacingData', function(RaceData)
        local ped = GetPlayerPed(-1)
        ...
        if dist <= 115.0 then
            ...
            GOVCore.Functions.Notify('You are too far from the race. Your navigation is set to the race.', 'error', 5000)
...
RegisterNUICallback('CanRaceSetup', function(data, cb)
    GOVCore.Functions.TriggerCallback('qb-lapraces:server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)

RegisterNUICallback('GetPlayerHouses', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetPlayerHouses', function(Houses)
        cb(Houses)
    end)
end)
...
RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('SetGPSLocation', function(data, cb)
    ...
    GOVCore.Functions.Notify('GPS is set!', 'success')
end)
...
RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)

RegisterNUICallback('GetCurrentpolices', function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetCurrentpolices', function(lawyers)
        cb(lawyers)
    end)
end)

RegisterNUICallback("GetCurrentDrivers", function(data, cb)
    GOVCore.Functions.TriggerCallback('gov-phone:server:GetCurrentDrivers', function(drivers)
        cb(drivers)
    end)
end)
